#ifndef FRONTIER_DEGREE_DISTRIBUTION_HPP
#define FRONTIER_DEGREE_DISTRIBUTION_HPP
...
class FrontierDegreeDistributionSpec
    : public tdzdd::PodArrayDdSpec<FrontierDegreeDistributionSpec, FrontierDSData, 2> {
private:
    // input graph
...
public:
    FrontierDegreeDistributionSpec(const tdzdd::Graph& graph,
...
#endif // FRONTIER_DEGREE_DISTRIBUTION_HPP
